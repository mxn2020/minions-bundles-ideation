    ...
    return (
        <div className="app">
            <header className="hero">
                ...
                <p className="tagline">Brainstorming and early-stage planning bundle — ideas, feature specs, roadmaps</p>
            ...
            <main className="content">
                <section className="features">
                    <div className="feature-card">
                        ...
                        <code>npm install @minions-bundles-ideation/sdk</code>
                    </div>
                    <div className="feature-card">
                        <h3>Python SDK</h3>
                    ...
                    <div className="feature-card">
                        <h3>CLI Tool</h3>
                        <code>npm install -g @minions-bundles-ideation/cli</code>
                    </div>
                </section>
            </main>
