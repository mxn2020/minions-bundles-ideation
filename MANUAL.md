# Manual Setup Steps for Minions Bundle: Ideation
...
Go to **GitHub → mxn2020/minions-bundles-ideation → Settings → Secrets and variables → Actions** and add:
...
### Web App (Playground)
- **Netlify site name**: `minions-bundles-ideation-web`
- **GitHub repo**: `mxn2020/minions-bundles-ideation`
...
### Documentation
- **Netlify site name**: `minions-bundles-ideation-docs`
- **GitHub repo**: `mxn2020/minions-bundles-ideation`
...
### Blog
- **Netlify site name**: `minions-bundles-ideation-blog`
- **GitHub repo**: `mxn2020/minions-bundles-ideation`
...
|--------|------|------|-------|
| Docs | CNAME | `ideation.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `ideation.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `ideation.minions.wtf` | _(Netlify subdomain)_ |
...
| Item | Value |
|------|-------|
| Project | `minions-bundles-ideation` |
| SDK (npm) | `undefined` |
| CLI (npm) | `undefined` |
| Python (PyPI) | `undefined` |
| GitHub | `github.com/mxn2020/minions-bundles-ideation` |
